...
def get_agent_graph():
    ...
    system_prompt = (
        ...
        "     b. Inform the crew (Clyde, Leon, Max) about the new venue details using `send_whatsapp_message_tool` with a friendly, informal, and buddy-like message, and explicitly notify them that you are now messaging the client Mr Muza (+263717713380) to acquire details.\n"
