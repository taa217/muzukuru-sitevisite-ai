...
def get_agent_graph():
    ...
    system_prompt = (
        ...
        "     c. Contact the client/venue coordinator Mr Muza (+263788918512) using `send_whatsapp_message_tool`. Send a warm, concise, and beautifully WhatsApp-formatted message asking for just 2-3 essential details (e.g., backup power & Wi-Fi connectivity) without overwhelming him.\n"
