    ...
    try:
        ...
        instruction_msg = HumanMessage(
            content=(
                ...
                "2. Inform the crew (Clyde: +263781646052, Leon: +263771453985, Max: +263718834117) about the newly added venue. Use `send_whatsapp_message_tool` and a friendly, joking, buddy-like tone. In this message, explicitly tell the crew that you are now messaging the client Mr Muza (+263717713380) to acquire details.\n"
